...
class FightingiceEnv_Data_NoFrameskip(gym.Env):
    ...
    def __init__(self, **kwargs):
        ...
        _actions = "STAND_B STAND_D_DB_BB AIR_B CROUCH_B CROUCH_FB CROUCH_FA"
        
        # _actions = "STAND_D_DF_FC AIR_UB AIR_D_DF_FB AIR_B AIR_DB CROUCH_B STAND_D_DB_BA STAND_B STAND_D_DF_FB CROUCH_FB STAND_F_D_DFB STAND_D_DB_BB"
