...
class FightingiceEnv_Data_Frameskip(gym.Env):
    ...
    def __init__(self, **kwargs):
        ...
        # _actions = "STAND_B STAND_D_DB_BB AIR_B CROUCH_B CROUCH_FB CROUCH_FA DASH DASH"
        _actions = "AIR AIR_A AIR_B AIR_D_DB_BA AIR_D_DB_BB AIR_D_DF_FA AIR_D_DF_FB AIR_DA"
